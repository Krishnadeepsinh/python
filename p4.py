#WAP TO CREATE LIST TO STORE YOUR FAVOURITE DESTINATION IN INDIA & CREATE LIST 
# TO STORE 10  VALUES IN IT 
#NAME=KRISHNADEEPSINH
#DATE=3/1/26

destination=["GOA","MANALI","BANGLORE","PUNE","JAIPUR","UDAIPUR","RAJKOT","SURAT","SIMLA","SHIKKIM"]
